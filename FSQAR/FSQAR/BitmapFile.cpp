...
//
// The following example code defines a function that uses a BITMAPINFO 
// structure and allocates memory for and initializes members within 
// a BITMAPINFOHEADER structure. Note that the BITMAPINFO structure cannot 
// be used with either a BITMAPV4HEADER or a BITMAPV5HEADER structure.
// 
...
//
// The following example code defines a function that initializes 
// the remaining structures, retrieves the array of palette indices, 
// opens the file, copies the data, and closes the file. 
// 
